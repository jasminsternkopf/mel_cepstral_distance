...
from mel_cepstral_distance.helper import extract_extract_frames_from_signal
...
def test_simple_signal():
  ...
  hop_len_samples = 2
  result = extract_extract_frames_from_signal(signal, non_silent_frames, hop_len_samples)
